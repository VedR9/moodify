...
export default function BottomNav() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-[#0a0a0a] border-t border-[#282828] flex items-center justify-around px-2 pt-2 pb-6 z-50">
      {ITEMS.map(({ label, icon: Icon, path }) => {
        ...
        return (
          ...
          >
            ...
            {active && <div className="w-1 h-1 rounded-full bg-sp-green absolute bottom-2" />}
          </button>
        )
      })}
    </div>
